...
<div id="go-portfolio-admin-wrap" class="wrap">
	...
	?>
	<!-- form -->
	<form id="go-portfolio-cpt-form" name="go-portfolio-cpt-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<div class="postbox">
			...
			<div class="inside">
				<table class="form-table">
					<tr>
						<th class="gw-gopf-w150"><span class="go-portfolio-icon-add-rule"></span><div><?php _e( 'Select a custom post type', 'go_portfolio_textdomain' ); ?></div></th>
		...
		<p class="submit">
			<input type="submit" class="button-primary go-portfolio-edit" data-label-m="<?php esc_attr_e( 'Edit', 'go_portfolio_textdomain' ); ?>" data-label-o="<?php esc_attr_e( 'Create New', 'go_portfolio_textdomain' ); ?>" value="<?php esc_attr_e( 'Create New', 'go_portfolio_textdomain' ); ?>" />
	...
	<form id="go-portfolio-cpt-form" name="go-portfolio-cpt-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<div class="postbox">
			...
			<div class="inside">
				<table class="form-table">
					<tr>
						<th class="gw-gopf-w150"><?php _e( 'Plural name', 'go_portfolio_textdomain' ); ?></th>
						<td class="gw-gopf-w300"><input type="text" name="name" value="<?php echo esc_attr( isset( $custom_post_type['name'] ) ? $custom_post_type['name'] : '' ); ?>" class="gw-gopf-w250" /></td>
						<td><p class="description"><?php _e( "General name for the post type, usually plural (e.g. Portfolio).", 'go_portfolio_textdomain' ); ?></p></td>
					</tr>							
					<tr>
						<th class="gw-gopf-w150"><?php _e( 'Singular name', 'go_portfolio_textdomain' ); ?></th>
						<td class="gw-gopf-w300"><input type="text" name="singular_name" value="<?php echo esc_attr( isset( $custom_post_type['singular_name'] ) ? $custom_post_type['singular_name'] : '' ); ?>" class="gw-gopf-w250" /></td>
						<td><p class="description"><?php _e( "Name for one object of this post type (e.g. Portfolio post).", 'go_portfolio_textdomain' ); ?></p></td>
					</tr>
					<tr>
						<th class="gw-gopf-w150"><?php _e( 'Slug', 'go_portfolio_textdomain' ); ?></th>
						<td class="gw-gopf-w300"><input type="text" name="slug" value="<?php echo esc_attr( isset( $custom_post_type['slug'] ) ? $custom_post_type['slug'] : '' ); ?>" class="gw-gopf-w250" /></td>
					...
					<tr>
						<th class="gw-gopf-w150"><?php _e( 'Enabled', 'go_portfolio_textdomain' ); ?></th>
						<td class="gw-gopf-w300"><label><input type="checkbox" name="enabled" <?php echo isset( $custom_post_type['enabled'] ) ? 'value="1" checked="checked"' : ''; ?> /> <?php _e( 'Yes', 'go_portfolio_textdomain' ); ?></label></td>
