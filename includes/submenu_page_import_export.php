				...
				if ( isset( $portfolios ) && !empty( $portfolios ) ) {
					...
					foreach( $portfolios as $portfolio_key => $portfolio ) {
						...
						if ( $key && isset( $_POST['import']['portfolio'][$key]['id'] ) ) {
							$replaced_pf_cnt++; 
							$_POST['import']['portfolio'][$key]['id'] = $_POST['import']['cpt'][$key]['slug'] . '_copy_' . $key;
						}						
					}					
				}
			}
...
<div id="go-portfolio-admin-wrap" class="wrap">
	...
	?>
	<!-- form -->
	<form id="go-portfolio-import-form" name="go-portfolio-import-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<div class="postbox">
			...
			<div class="inside">
				<table class="form-table">
					<tr>
						<th class="gw-gopf-w150"><div><?php _e( 'Select action', 'go_portfolio_textdomain' ); ?></div></th>
						<td class="gw-gopf-w300">
							<select id="go-portfolio-select" name="action-type" class="gw-gopf-w250" data-parent="import-export">
					...
					<!-- import -->
					<tr class="gw-go-portfolio-group" data-parent="import-export" data-children="import">
					...
					<tr class="gw-go-portfolio-group" data-parent="import-export" data-children="export">
						<th class="gw-gopf-w150"><div><?php _e( 'Custom post type', 'go_portfolio_textdomain' ); ?></div></th>
						<td class="gw-gopf-w300">
							<ul class="go-portfolio-checkbox-list">
								<li><label><input type="checkbox" name="export[cpt][]" value="all" class="go-portfolio-checkbox-parent"> <?php _e( 'All custom post types', 'go_portfolio_textdomain' ); ?> [&nbsp;.&nbsp;]<span></span></label>
									<ul class="go-portfolio-checkbox-list">
					...
					<tr class="gw-go-portfolio-group" data-parent="import-export" data-children="export">
						<th class="gw-gopf-w150"><div><?php _e( 'Portfolio', 'go_portfolio_textdomain' ); ?></div></th>
						<td class="gw-gopf-w300">
							<ul class="go-portfolio-checkbox-list">
								<li><label><input type="checkbox" name="export[portfolio][]" value="all" class="go-portfolio-checkbox-parent"> <?php _e( 'All portfolios', 'go_portfolio_textdomain' ); ?> [&nbsp;.&nbsp;]<span></span></label>
									<ul class="go-portfolio-checkbox-list">
			...
			<div class="inside">
				<table class="form-table">
					...
					<tr>
						...
						<td class="gw-gopf-w300">
							<ul class="go-portfolio-checkbox-list">
								<li><label><input type="checkbox" name="import[cpt][all]" value="<?php echo implode( ',', array_keys( $temp_post_data['cpt'] ) ); ?>" class="go-portfolio-checkbox-parent"> <?php _e( 'All custom post types', 'go_portfolio_textdomain' ); ?> [&nbsp;.&nbsp;]<span class="go-portfolio-closed"></span></label>
									<ul class="go-portfolio-checkbox-list">
					...
					<tr>
						...
						<td class="gw-gopf-w300">
							<ul class="go-portfolio-checkbox-list">
								<li><label><input type="checkbox" name="import[portfolio][all]" value="<?php echo implode( ',', array_keys( $temp_post_data['portfolio'] ) ); ?>" class="go-portfolio-checkbox-parent"> <?php _e( 'All Portfolios', 'go_portfolio_textdomain' ); ?> [&nbsp;.&nbsp;]<span class="go-portfolio-closed"></span></label>
									<ul class="go-portfolio-checkbox-list">
					...
					<tr>
						<th class="gw-gopf-w150"><div><?php _e( 'Replace existing items?', 'go_portfolio_textdomain' ); ?></div></th>
	...
	<div class="postbox">
		...
		<div class="inside">
			<table class="form-table">
				...
				<tr>
					<th><textarea id="go-portfolio-db-data" name="db-data" style="width:100%;" rows="10"><?php echo !empty( $export_data ) ? base64_encode( serialize( $export_data ) ) : ''; ?></textarea></th>
			   </tr>
			</table>
		</div> 				
	</div> 
