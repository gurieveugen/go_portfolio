...
<div id="go-portfolio-admin-wrap" class="wrap">
	...
	?>
	<!-- form -->
	<form id="go-portfolio-editor-form" name="go-portfolio-editor-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<div class="postbox">
			...
			<div class="inside">
				<table class="form-table">
					<tr>
						<th class="gw-gopf-w150"><div><?php _e( 'Select template or style', 'go_portfolio_textdomain' ); ?></div></th>
						<td class="gw-gopf-w300">
							<select name="item" class="gw-gopf-w250">
								<!-- Templates -->
		...
		<p class="submit">
			<input type="submit" class="button-primary go-portfolio-edit" value="<?php esc_attr_e( 'Edit', 'go_portfolio_textdomain' ); ?>" />
			<input type="button" class="button-secondary go-portfolio-reset" value="<?php esc_attr_e( 'Reset All', 'go_portfolio_textdomain' ); ?>" />
			<input type="button" class="button-secondary go-portfolio-import" value="<?php esc_attr_e( 'Import New', 'go_portfolio_textdomain' ); ?>" />
		</p>
	...
	<!-- form -->
	<form id="go-portfolio-editor-form" name="go-portfolio-editor-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		<input id="go-portfolio-action-type" name="action-type" type="hidden" value="edit-item" />
...
You can make further modications for each portfolio when creating a portfolio.', 'go_portfolio_textdomain' ); ?></th>						
		...
		<p class="submit">
			<?php if ( isset( $item_data['data'] ) ) : ?><input type="submit" class="button-primary go-portfolio-edit-item" value="<?php esc_attr_e( 'Save', 'go_portfolio_textdomain' ); ?>" /><?php endif; ?>
			<input type="button" class="button-secondary go-portfolio-reset-item" value="<?php esc_attr_e( 'Reset', 'go_portfolio_textdomain' ); ?>" />
		</p>
